...
import rospy
import math
from hexapod_gazebo.phantomx import PhantomX
from geometry_msgs.msg import Twist


jleg = ['coxa_joint', 'femur_joint', 'tibia_joint']
suffix = ['F', 'M', 'R']
sides = ['L', 'R']
joints = []
for j in jleg:
...
class WFunc:
    ...
    def generate(self):
        ...
        self.set_func('femur_joint', f1, f2)
        self.set_func('tibia_joint', f3, f4)
        self.set_func('coxa_joint', zero, zero)
    ...
    def apply_velocity(self, angles, velocity, phase, x):
        ...
        d = (x * 2 - 1) * v
        if phase:
            angles['coxa_joint_LF'] -= d
            angles['coxa_joint_RM'] += d
            angles['coxa_joint_LR'] -= d
            angles['coxa_joint_RF'] -= d
            angles['coxa_joint_LM'] += d
            angles['coxa_joint_RR'] -= d
        else:
            angles['coxa_joint_LF'] += d
            angles['coxa_joint_RM'] -= d
            angles['coxa_joint_LR'] += d
        ...
        # if v>=0:
        #     if phase:
        #         angles["femur_joint1_l"]-=d
        #         angles["j_ankle2_l"]-=d
        #         angles["femur_joint1_r"]+=d
        #         angles["j_ankle2_r"]+=d
        #     else:
        #         angles["femur_joint1_l"]-=d2
        #         angles["j_ankle2_l"]-=d2
        #         angles["femur_joint1_r"]+=d2
